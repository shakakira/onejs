...
function loadSubpackages(pkg, options, callback){
}

function loadModules(pkg, options, callback){
}

function setMainModule(pkg, options, callback){
...
function content(pkg, options, callback){
  ...
  dependencies(pkg, options, function(error, deps){
    ...
    modules(pkg, options, function(error, modules){
      ...
      var i = modules.length, m, errormsg;
